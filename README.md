...
| M1 | MVP：3 款第一批游戏（2048/数独/记忆翻牌原生）+ 游戏壳帮助/设置联动 + 统一存档（纸牌接龙已于 v0.2.2 移除） | ✅ 功能完成（模拟器+真机验证；试玩见 docs/01、docs/06） |
| M2 | 新一批游戏：斗地主 / 五子棋 / 连连看 / 找不同（见 [docs/11](docs/11-M2规划.md)）+ 无障碍实机走查 | ⏳ 规划完成，待开工 |
